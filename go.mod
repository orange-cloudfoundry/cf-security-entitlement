...
require (
	...
	github.com/orange-cloudfoundry/gobis v1.23.6
	github.com/orange-cloudfoundry/gobis-middlewares v1.41.0
...
require (
	...
	github.com/cloudfoundry/bosh-utils v0.0.369 // indirect
