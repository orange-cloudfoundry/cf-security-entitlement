...
require (
	...
	github.com/orange-cloudfoundry/gobis v1.13.0
	github.com/orange-cloudfoundry/gobis-middlewares v1.17.0
...
require (
	...
	github.com/cloudfoundry/bosh-utils v0.0.309 // indirect
