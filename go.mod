...
require (
	...
	github.com/orange-cloudfoundry/gobis v1.22.0
	github.com/orange-cloudfoundry/gobis-middlewares v1.33.0
...
require (
	...
	github.com/cloudfoundry/bosh-utils v0.0.338 // indirect
